...
public class BNHillClimbing extends HillClimbing implements BNStructureLearningAlgorithm {
	...
	public boolean[][] findStructure() {
		...
		do {
			...
			findBestNeighbor(bestStructure, scores, adjacencyMatrices, cache, "addition");
			// Structures generated by deletion
			findBestNeighbor(bestStructure, scores, adjacencyMatrices, cache, "deletion");
			// Structures generated by reversal
			findBestNeighbor(bestStructure, scores, adjacencyMatrices, cache, "reversal");
	...
	private void findBestNeighbor(boolean[][] bestStructure, double[] scores, boolean[][][] adjacencyMatrices,
			Cache<boolean[][], Double> cache, String operation) {
	 ...
	 * @return
	 */
	private double computeScore(boolean[][] adjacencyMatrix, Cache<boolean[][], Double> cache) {
