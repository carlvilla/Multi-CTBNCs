...
public class DAG extends AbstractStructureConstraints {
     ...
     * method determines if there are cycles in an adjacency matrix.
     *
     * @param adjacencyMatrix adjacency matrix
     * @return true if the structure is valid, false otherwise
     * @see <a href="https://www.geeksforgeeks.org/detect-cycle-in-a-directed-graph-using-bfs">https://www.geeksforgeeks.org/detect-cycle-in-a-directed-graph-using-bfs</a>.
     */
    @Override
