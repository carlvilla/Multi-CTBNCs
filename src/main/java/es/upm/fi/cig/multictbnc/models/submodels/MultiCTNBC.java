 ...
 * Bayes classifier (Multi-CTBNC) where any subgraph has arcs except the bridge
 ...
 *
 */
public class MultiCTNBC<NodeTypeBN extends Node, NodeTypeCTBN extends Node> extends MultiCTBNC<NodeTypeBN, NodeTypeCTBN> {
