 ...
 */
public class DAG_maxK_MultiCTBNC<NodeTypeBN extends Node, NodeTypeCTBN extends Node> extends
		MultiCTBNC<NodeTypeBN, NodeTypeCTBN> {
	int maxK;

	/**
	 * Constructs a {@code DAG_maxK_MultiCTBNC} by receiving the learning algorithms for Bayesian networks and
	 * continuous-time Bayesian networks and the maximum number of parents of the feature variables (apart from the
	 * class variables).
	 *
