...
/**
 * Class used to sample sequences from a Multi-CTBNC.
 * 
...
public class MainSampling {
	...
	public static void main(String[] args) {
		...
		// Multi-CTBNC with the structure from the selected experiment
		MultiCTBNC<CPTNode, CIMNode> multiCTBNC = generateModelSelectedExperiment(selectedExperiment, forceExtremeProb,
	 ...
	 */
	private static MultiCTBNC<CPTNode, CIMNode> generateModelSelectedExperiment(String selectedExperiment,
