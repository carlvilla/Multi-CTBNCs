...
public abstract class DiscreteStateNode extends AbstractNode {
	 ...
	 * during training. Algorithm from <a
	 * href="https://github.com/dcodecasa/CTBNCToolkit">https://github.com/dcodecasa/CTBNCToolkit</a>.
	 *
	...
	/**
	 * Sets the states of the parents of the node given the index related to their state. Algorithm from <a
	 * href="https://github.com/dcodecasa/CTBNCToolkit">https://github.com/dcodecasa/CTBNCToolkit</a>.
	 *
	...
	public String toString() {
		...
		String sb = commonDescription + "Possible states: " + this.indexerStates;
		return sb;
	}
