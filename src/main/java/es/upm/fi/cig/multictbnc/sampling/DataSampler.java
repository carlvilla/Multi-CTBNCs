...
public class DataSampler {
    ...
    /**
     * Generate a uniformly distributed random conditional intensity matrix for a node of a continuous-time Bayesian
     * network.
     *
     * @param node         node of a continuous-time Bayesian network
     * @param minIntensity minimum value of the intensities
     * @param maxIntensity maximum value of the intensities
     */
    public static void generateRandomCIM(CIMNode node, double minIntensity, double maxIntensity) {
    ...
    protected static MultiCTBNC<CPTNode, CIMNode> generateModel(int numFeatureVariables, int numClassVariables,
                                                                ...
                                                                double probabilityEdgeFeatureSubgraph, int minIntensity,
    ...
    public static void generateRandomCPTs(BN<CPTNode> bn, boolean forceExtremeProb) {
        ...
        for (CPTNode node : bn.getNodes())
            generateRandomCPT(node, forceExtremeProb);
    }
     ...
     *                         sample space of the class variables is 2, false otherwise
     */
    public static void generateRandomCPT(CPTNode node, boolean forceExtremeProb) {
