...
/**
 * Implements a Multi-CTBNC with empty class subgraph and a K-dependence continuous
 ...
 */
public class Empty_maxK_MultiCTBNC<NodeTypeBN extends Node, NodeTypeCTBN extends Node>
		extends MultiCTBNC<NodeTypeBN, NodeTypeCTBN> {
	int maxK;

	/**
	 * Constructs a {@code Empty_maxK_Multi-CTBNC} by receiving the learning algorithms
	 ...
	 */
	public Empty_maxK_MultiCTBNC(BNLearningAlgorithms bnLearningAlgs, CTBNLearningAlgorithms ctbnLearningAlgs, int maxK,
