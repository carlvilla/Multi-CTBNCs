...
public abstract class CTBNParameterLearningAlgorithm implements ParameterLearningAlgorithm {
	...
	public void setSufficientStatistics(Node node, Dataset dataset) {
		CTBNSufficientStatistics ssNode = getSufficientStatisticsNode((DiscreteStateNode) node, dataset);
	 ...
	 */
	protected abstract CTBNSufficientStatistics getSufficientStatisticsNode(DiscreteStateNode node, Dataset dataset);
