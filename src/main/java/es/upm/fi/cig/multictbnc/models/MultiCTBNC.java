...
import es.upm.fi.cig.multictbnc.learning.structure.constraints.CTBNC.CTBNC;
 ...
 */
public class MultiCTBNC<NodeTypeBN extends Node, NodeTypeCTBN extends Node> extends AbstractPGM<Node>
	...
	/**
	 * Receives learning algorithms for BNs and CTBNs to generate a Multi-CTBNC.
	 * 
	 ...
	 * represent the class subgraph and feature/bridge subgraph of a Multi-CTBNC,
	 * respectively.
	 * 
	...
	/**
	 * Defines the nodes of the Multi-CTBNC by using the nodes obtained from the BN and
	 * the CTBN.
	 */
	 ...
	 * the Multi-CTBNC. For now it is possible to define an empty structure or a naive
	 * Bayes.
	 * 
