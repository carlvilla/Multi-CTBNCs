...
public class Controller {
    ...
    public void changeModel() {
        ...
        if (model.equals("DAG-maxK Multi-CTBNC") || model.equals("Empty-maxK Multi-CTBNC"))
    ...
    private MultiCTBNC<CPTNode, CIMNode> getModel() {
        ...
        MultiCTBNC<CPTNode, CIMNode> model = ClassifierFactory.<CPTNode, CIMNode>getMultiCTBNC(selectedModel,
                bnLearningAlgs, ctbnLearningAlgs, hyperparameters, CPTNode.class, CIMNode.class);
        // Define initial structure
        model.setInitialStructure(this.cmbInitialStructure.getValue());
        return model;
    }
