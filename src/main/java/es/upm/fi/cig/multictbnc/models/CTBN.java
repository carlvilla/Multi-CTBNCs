...
public class CTBN<NodeType extends Node> extends AbstractPGM<NodeType> {
	 ...
	 * and a Bayesian network modeling the class subgraph of a Multi-CTBNC. This
	 ...
	 *                        Multi-CTBNC (necessary to estimate the conditional
	 *                        log-likelihood)
	 */
	...
	/**
	 * Initializes a continuous time Bayesian network by receiving a list of nodes,
	 * a Bayesian network modeling the class subgraph of a Multi-CTBNC and a training
	 * dataset. This constructor is used when the structure of the model is provided
	 * and to build a {@code MultiCTBNC}.
	 * 
	 * @param nodes           nodes that make up the model and define its structure
	 * @param bnClassSubgraph a Bayesian network modeling the class subgraph of a
	 *                        Multi-CTBNC (necessary to estimate the conditional
	 ...
	 * This constructor was thought to be used by a {@code MultiCTBNC}.
	 * 
	 ...
	 *                             a Multi-CTBNC (necessary to estimate the conditional
	 *                             log-likelihood)
