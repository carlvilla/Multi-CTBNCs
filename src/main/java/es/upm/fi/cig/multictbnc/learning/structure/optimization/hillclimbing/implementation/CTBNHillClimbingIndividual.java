package es.upm.fi.cig.multictbnc.learning.structure.optimization.hillclimbing.implementation;
...
import es.upm.fi.cig.multictbnc.learning.structure.optimization.hillclimbing.HillClimbingSolution;
...
public class CTBNHillClimbingIndividual implements HillClimbingImplementation {
	...
	/**
	 * Finds the best neighbor for a CTBN node. It returns the score of the
	 * neighbor, while the obtained adjacency matrix is stored in the parameter
	 * 'adjacencyMatrix'.
	 * 
	 * @param indexNode
