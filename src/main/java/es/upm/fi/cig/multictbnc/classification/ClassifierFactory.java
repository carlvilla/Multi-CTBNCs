...
public class ClassifierFactory {
	...
	/**
	 * Builds the specified classifier. The node type for the class variables is assumed to be a {@code CPTNode}, while
	 * for a feature variable a {@code CIMNode}.
	 *
	 ...
	 */
	public static MultiCTBNC getMultiCTBNC(String nameClassifier, BNLearningAlgorithms bnLearningAlgs,
	...
	/**
	 * Builds the specified classifier with the provided hyperparameters. The node type for the class variables is
	 * assumed to be a {@code CPTNode}, while for a feature variable a {@code CIMNode}.
	 *
	 * @param nameClassifier   name of the classifier to build
	 * @param bnLearningAlgs   parameter and structure learning algorithms for Bayesian networks
	 * @param ctbnLearningAlgs parameter and structure learning algorithms for continuous-time Bayesian networks
	...
	public static MultiCTBNC getMultiCTBNC(String nameClassifier, BNLearningAlgorithms bnLearningAlgs,
		...
		return getMultiCTBNC(nameClassifier, bnLearningAlgs, ctbnLearningAlgs, hyperparameters, CPTNode.class,
				CIMNode.class);
	}
