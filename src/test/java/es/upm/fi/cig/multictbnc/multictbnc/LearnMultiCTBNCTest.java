...
class LearnMultiCTBNCTest {
	...
	/**
	 * This method reads a training dataset that will be used to generate a Multi-CTBNC under different learning
	 * algorithms. The dataset is formed by six discrete-state variables, four feature variables (X1, X2, X3 and X4)
	 * and two class variables (C1 and C2). The data were sampled from a Multi-CTBNC with the following structure: X4 <- X3
	 * -> X2 <-> X1 <- C1 -> C2 -> X2
	 *
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using hill climbing and log-likelihood as
	 * score.
	 */
	@Test
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using hill climbing and the Bayesian
	 * Dirichlet equivalent score.
	 */
	@Test
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using hill climbing and the conditional
	 * log-likelihood score.
	 */
	@Test
	public void learnModelCLL() throws ErroneousValueException {
		// Algorithms to learn BN (class subgraph of Multi-CTBNC)
		BNParameterLearningAlgorithm bnParameterLearningAlgorithm = BNParameterLearningAlgorithmFactory.getAlgorithm(
				"Bayesian estimation", 1.0);
		Map<String, String> paramSLA = Map.of("scoreFunction", "Conditional log-likelihood");
		StructureLearningAlgorithm bnStructureLearningAlgorithm = StructureLearningAlgorithmFactory.getAlgorithmBN(
				"Hill climbing", paramSLA);
		bnLearningAlgs = new BNLearningAlgorithms(bnParameterLearningAlgorithm, bnStructureLearningAlgorithm);
		// Algorithms to learn CTBN (feature and bridge subgraph of Multi-CTBNC)
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using tabu search and log-likelihood as
	 * score.
	 */
	@Test
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using hill climbing with random restart
	 * and
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using the continuous-time PC algorithm.
	 */
	@Test
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using the Markov blanket-based
	 * continuous-time PC algorithm.
	 */
	@Test
	...
	/**
	 * Learns a multidimensional continuous-time Bayesian network classifier using a hybrid algorithm.
	 */
	@Test
